...
using FutureWorkshopsToDoList.Application.TodoItems.Commands.CreateTodoItem;
using FutureWorkshopsToDoList.Application.TodoItems.Commands.DeleteTodoItem;
using FutureWorkshopsToDoList.Application.TodoItems.Commands.UpdateTodoItem;
using FutureWorkshopsToDoList.Application.TodoItems.Commands.UpdateTodoItemDetail;
using FutureWorkshopsToDoList.Application.TodoItems.Queries.GetTodoItemsWithPagination;
using Microsoft.AspNetCore.Http.HttpResults;

namespace FutureWorkshopsToDoList.Web.Endpoints;
